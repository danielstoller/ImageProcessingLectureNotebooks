...
def main():
    ...
    sudokufile="/Users/theodorehuppert/Desktop/ECE1390/LectureNotebooks/Lectures/Lecture18/sudoku.png"    
    src=sudokufile
    cap = video.create_capture(src, fallback='synth:bg={}:noise=0.05'.format(sudokufile))
